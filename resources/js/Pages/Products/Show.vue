                    ...
                    <div class="ml-12">
                        ...
                        <div class="mt-5">
                            ...
                            <div v-if="showDetails" class="mt-4 ">
                                <ul class="mt-2">
                                    <li class="text-lg"><span class="font-bold">Flavor:</span> {{ product.flavor }}</li>
                                    <li class="text-lg"><span class="font-bold">Roast Level:</span> {{ product.roast_level }}</li>
                                    <li class="text-lg"><span class="font-bold">Brewing Method:</span> {{ product.brewing_method }}</li>
                                    <li class="text-lg"><span class="font-bold">Decaf:</span> {{ product.decaf === 1 ? 'Yes' : 'No' }}</li>
                                </ul>
                            </div>
                            <hr class="mt-5">
                        </div>
                    ...
                    <div v-if="product.reviews.length">
                        <div v-for="review in product.reviews" :key="review.id" class="mt-4 border-b border-gray-200 pb-4">
                            <div class="flex items-center">
                                <!-- <img :src="review.user.profile_photo_url" alt="User Avatar" class="w-10 h-10 rounded-full mr-4"> -->
                                <div>
