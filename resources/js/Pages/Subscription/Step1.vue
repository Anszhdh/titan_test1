...
const options = [
    { id: 'Nutty', label: 'Nutty Flavor', image: '/substep/step1/nutty.jpg' },
    { id: 'Fruity', label: 'Fruity Flavor', image: '/substep/step1/fruity.jpg' },
    { id: 'Chocolatey', label: 'Chocolatey Flavor', image: '/substep/step1/choc.jpg' },
    { id: 'Spicy', label: 'Spicy Flavor', image: '/substep/step1/spicy.jpeg' },
    { id: 'Others', label: 'Others', image: '/substep/step1/others.png' }
];
