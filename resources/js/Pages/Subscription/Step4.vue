...
const options = [
    { id: 14, label: 'Decaf', image: '/substep/step4/caffeine.jpg' },
    { id: 15, label: 'Low Caffeine', image: '/substep/step4/caffeine.jpg' },
    { id: 16, label: 'Regular Caffeine', image: '/substep/step4/caffeine.jpg' },
    { id: 17, label: 'High Caffeine', image: '/substep/step4/caffeine.jpg' }
];
