...
const options = [
    { id: 17, label: 'Decaf', image: '/substep/step5/caffeine.jpg' },
    { id: 18, label: 'Low caffeine', image: '/substep/step5/caffeine.jpg' },
    { id: 19, label: 'Regular caffeine', image: '/substep/step5/caffeine.jpg' },
    { id: 20, label: 'High caffeine', image: '/substep/step5/caffeine.jpg' }
];
...
function nextStep() {
    Inertia.post('/subscription/step6', { step5: selectedOptions.value });
}
</script>
...
<template>
    ...
    <div class="container mx-auto px-4 py-8 bg-orange-100/5">
        <h2 class="text-center text-2xl font-bold mb-4">How much caffeine do you prefer in your coffee?</h2>
